        ...
        <div className='min-h-screen'>
            <div className="pb-4 pt-1 bg-gradient-to-b from-gray-300 to-white">
                ...
                <div className="bg-gray-100 rounded-2xl shadow-lg px-6 pb-6 flex relative ml-10 mr-10 pt-16 -mt-20 text-xl">
                    <div className="flex w-2/3">
                        <h1 className="text-5xl font-bold text-gray-900 pt-5 pl-5 h-fit">Gynecologist<span className="font-normal"></span></h1>
                    </div>
            ...
            <div className=' relative  flex  p-6 mx-12 '>
                ...
                <div className='relative  w-8/12 flex flex-col my-2 mx-6'>
                    ...
                    <h1 className="text-5xl font-semibold text-gray-800 pt-10 pb-4 mb-3 pl-3">Gynecologist</h1>
                    <div className='text-lg h-auto text-gray-500 mb-4'>Gynecology is a medical specialty focused on the health of the female reproductive system, including the uterus, ovaries, fallopian tubes, and breasts. Gynecologists are trained to diagnose, treat, and manage a wide range of conditions affecting women's reproductive health, providing both routine care and specialized treatments.</div>
                    <div className='text-lg h-auto text-gray-500 my-4'>Gynecologists also address menstrual disorders, such as irregular periods, heavy bleeding, and painful menstruation (dysmenorrhea). They diagnose underlying conditions like polycystic ovary syndrome (PCOS) and endometriosis, which can impact menstrual health and fertility. Treatments may include hormonal therapies, lifestyle modifications, and surgical interventions.</div>
                    <div className='text-lg h-auto text-gray-500 mt-4'>Gynecologists also manage menopause, offering treatments to alleviate symptoms like hot flashes, mood swings, and vaginal dryness. Hormone replacement therapy (HRT) and other medications can help manage these symptoms and improve quality of life.</div>

                    <h1 className="text-5xl font-semibold text-gray-800 pt-10 pb-4 mb-3 pl-3">Doctors Under Gynecologist </h1>
