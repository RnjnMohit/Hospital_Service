        ...
        <div className='min-h-screen'>
            <div className="pb-4 pt-1 bg-gradient-to-b from-gray-300 to-white">
                ...
                <div className="bg-gray-100 rounded-2xl shadow-lg px-6 pb-6 flex relative ml-10 mr-10 pt-16 -mt-20 text-xl">
                    <div className="flex w-2/3">
                        <h1 className="text-5xl font-bold text-gray-900 pt-5 pl-5 h-fit">Dentist<span className="font-normal"></span></h1>
                    </div>
            ...
            <div className=' relative  flex  p-6 mx-12 '>
                ...
                <div className='relative  w-8/12 flex flex-col my-2 mx-6'>
                    ...
                    <div className='text-lg h-auto text-gray-500 mb-4'>Dentistry is a branch of medicine focused on the health of the teeth, gums, and related structures of the mouth. Dentists diagnose, prevent, and treat oral diseases and conditions, playing a crucial role in maintaining overall health. The practice encompasses various fields, including general dentistry, orthodontics, periodontics, endodontics, prosthodontics, and oral surgery.</div>
                    <div className='text-lg h-auto text-gray-500 my-4'>General dentists provide primary dental care, including routine check-ups, cleanings, fillings, and preventive education. They are the first line of defense against oral diseases such as cavities, gum disease, and oral cancer. Regular visits to a general dentist are essential for maintaining oral hygiene and detecting potential issues early.</div>
                    <div className='text-lg h-auto text-gray-500 mt-4'>Orthodontics is a specialty focused on diagnosing, preventing, and correcting misaligned teeth and jaws. Orthodontists use devices such as braces, aligners, and retainers to straighten teeth, improve bite function, and enhance overall oral health. This field not only improves aesthetics but also addresses functional issues that can impact speech, chewing, and oral hygiene.

                        Periodontics involves the prevention, diagnosis, and treatment of gum disease, which can lead to tooth loss if untreated. Periodontists perform procedures such as scaling and root planing, gum grafts, and the placement of dental implants to restore oral health and function.</div>
