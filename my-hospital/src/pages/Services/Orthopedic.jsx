        ...
        <div className='min-h-screen'>
            <div className="pb-4 pt-1 bg-gradient-to-b from-gray-300 to-white">
                ...
                <div className="bg-gray-100 rounded-2xl shadow-lg px-6 pb-6 flex relative ml-10 mr-10 pt-16 -mt-20 text-xl">
                    <div className="flex w-2/3">
                        <h1 className="text-5xl font-bold text-gray-900 pt-5 pl-5 h-fit">Orthopedic<span className="font-normal"></span></h1>
                    </div>
            ...
            <div className=' relative  flex  p-6 mx-12 '>
                ...
                <div className='relative  w-8/12 flex flex-col my-2 mx-6'>
                    ...
                    <h1 className="text-5xl font-semibold text-gray-800 pt-10 pb-4 mb-3 pl-3">Orthopedic</h1>
                    <div className='text-lg h-auto text-gray-500 mb-4'>
                        Orthopedics is a branch of medicine focused on diagnosing, treating, and managing disorders of the musculoskeletal system, which includes bones, joints, muscles, ligaments, tendons, and nerves. This specialty addresses conditions ranging from congenital deformities and trauma injuries to degenerative diseases like osteoarthritis and osteoporosis.</div>
                    <div className='text-lg h-auto text-gray-500 my-4'>Orthopedic surgeons employ both surgical and non-surgical methods to treat musculoskeletal issues. Non-surgical treatments often include physical therapy, medications, and lifestyle modifications. However, when these interventions are insufficient, surgical options such as joint replacement, arthroscopy, and spinal fusion may be necessary. Technological advancements have significantly impacted orthopedics, introducing minimally invasive techniques and robotic-assisted surgeries, which offer improved precision and faster recovery times.</div>
                    <div className='text-lg h-auto text-gray-500 mt-4'>Pediatric orthopedics deals with congenital disorders like clubfoot and scoliosis, while sports medicine focuses on injuries related to athletic activities, such as ligament tears and fractures. Additionally, orthopedic trauma care is critical for treating acute injuries resulting from accidents and falls, requiring immediate and often complex surgical intervention.</div>

                    <h1 className="text-5xl font-semibold text-gray-800 pt-10 pb-4 mb-3 pl-3">Doctors Under Orthopedic </h1>
