        ...
        <div className='min-h-screen'>
            <div className="pb-4 pt-1 bg-gradient-to-b from-gray-300 to-white">
                ...
                <div className="bg-gray-100 rounded-2xl shadow-lg px-6 pb-6 flex relative ml-10 mr-10 pt-16 -mt-20 text-xl">
                    <div className="flex w-2/3">
                        <h1 className="text-5xl font-bold text-gray-900 pt-5 pl-5 h-fit">Andrologists<span className="font-normal"></span></h1>
                    </div>
            ...
            <div className=' relative  flex  p-6 mx-12 '>
                ...
                <div className='relative  w-8/12 flex flex-col my-2 mx-6'>
                    ...
                    <div className='text-lg h-auto text-gray-500 mb-4'>Andrology is a medical specialty focusing on male health, particularly related to the male reproductive system and urological issues. Andrologists diagnose, treat, and manage conditions affecting male fertility, sexual health, and hormone levels, playing a crucial role in men's overall well-being.</div>
                    <div className='text-lg h-auto text-gray-500 my-4'>Andrologists investigate causes of infertility such as low sperm count, poor sperm motility, and abnormal sperm morphology. They conduct various tests, including semen analysis and hormonal evaluations, to identify underlying issues. Treatments for male infertility may involve lifestyle modifications, medications, hormone therapy, or assisted reproductive techniques like in vitro fertilization (IVF) and intracytoplasmic sperm injection (ICSI).</div>
                    <div className='text-lg h-auto text-gray-500 mt-4'>Andrologists also manage hormonal disorders, particularly low testosterone levels, which can affect libido, energy levels, and overall health. Hormone replacement therapy (HRT) may be prescribed to restore hormone balance and alleviate symptoms associated with low testosterone.</div>
