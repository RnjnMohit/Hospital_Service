...
import { FaPhoneAlt, FaPrint, FaEnvelope, FaShareAlt, FaFacebook, FaLinkedin, FaTwitter, FaLongArrowAltRight, FaHospitalUser } from 'react-icons/fa';
        ...
        {boxes.map((box, index) => (
          ...
          >
            ...
            <a href="#" className="group text-custom-blue hover:underline flex flex-row items-center space-x-2">
              ...
              <span className='transition-transform duration-700 group-hover:-translate-x-6'>Read More</span>
            </a>
          </Link>
        ))}
      </div>
