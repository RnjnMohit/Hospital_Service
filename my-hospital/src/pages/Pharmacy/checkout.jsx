            ...
            <div className="pb-4 pt-1 bg-gradient-to-b from-gray-300 to-white">
                ...
                <div className="bg-gray-100 rounded-2xl shadow-lg px-6 pb-6 flex relative ml-10 mr-10 pt-16 -mt-20 text-xl">
                    <div className="flex w-2/3">
                        <h1 className="text-5xl font-bold text-gray-900 pt-5 pl-5 h-fit">Checkout <span className="font-normal"></span></h1>
                    </div>
            ...
            <div className="flex mx-28 my-5">
                ...
                <div className="p-6 bg-white rounded-md shadow-md w-1/3">
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody>
                            <tr>
                                <td className="py-2">Dettol x 1</td>
                                <td className="py-2">Rs. 180.00</td>
                            </tr>
                            <tr>
                                <td className="py-2">Mask x 1</td>
                                <td className="py-2">Rs. 30.00</td>
                            </tr>
                            <tr>
                                <td className="py-2">Prega News x 1</td>
                                <td className="py-2">Rs. 80.00</td>
                            </tr>

                            <tr className="font-bold">
                                <td className="py-2">Total</td>
                                <td className="py-2">Rs. 290.00</td>
                            </tr>
                        </tbody>
                    </table>

                    <button className="w-full mt-6 px-4 py-2 font-bold text-2xl bg-emerald-500 text-white transform duration-300 rounded-3xl hover:bg-emerald-700">Place Order</button>
                </div>
            </div>
        </>
    )
