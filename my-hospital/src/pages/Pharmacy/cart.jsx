...
import pn from '../../assets/pharmacybg_files/preg.jpg';
...
function Cart() {
    ...
    const [cart, setCart] = useState([
        { id: 1, name: 'Dettol', price: 180.00, quantity: 1, image: dettol },
        { id: 2, name: 'Prega News', price: 80.00, quantity: 1, image: pn },
        { id: 3, name: 'Mask', price: 30.00, quantity: 1, image: mask },
    ]);
